...
class TurnOnWifiScreen extends StatefulWidget {
  const TurnOnWifiScreen({Key? key}) : super(key: key);

  @override
  State<TurnOnWifiScreen> createState() =>
      _TurnOnWifiScreenState();
}

class _TurnOnWifiScreenState
    extends State<TurnOnWifiScreen> {
  @override
